...
#define LOGT(domain, ...) softeq::common::log().Message(softeq::common::LogLevel::TRACE, domain, __VA_ARGS__)
#define LOGD(domain, ...) softeq::common::log().Message(softeq::common::LogLevel::DEBUG, domain, __VA_ARGS__)
#define LOGI(domain, ...) softeq::common::log().Message(softeq::common::LogLevel::INFO, domain, __VA_ARGS__)
#define LOGW(domain, ...) softeq::common::log().Message(softeq::common::LogLevel::WARNING, domain, __VA_ARGS__)
#define LOGE(domain, ...) softeq::common::log().Message(softeq::common::LogLevel::ERROR, domain, __VA_ARGS__)
#define LOGC(domain, ...) softeq::common::log().Message(softeq::common::LogLevel::CRITICAL, domain, __VA_ARGS__)
#define LOGF(domain, ...) softeq::common::log().Message(softeq::common::LogLevel::FATAL, domain, __VA_ARGS__)
#define LOGSYS(domain, ...) softeq::common::log().SystemError(domain, __VA_ARGS__)
