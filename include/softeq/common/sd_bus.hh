...
public:
    ...
    */
    ...
    /*!
       ...
       \return Any object
     */
    Any property(const std::string &key) noexcept;
     ...
     */
    bool setProperty(const std::string &key, Any &val) noexcept;
...
private:
    ...
    static SdBusTypes getAnyType(Any &anyVal);
    ...
    bool propertiesManipulations(const std::string &key, Any &val, bool isSet);
